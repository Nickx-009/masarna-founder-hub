...
const Podcast = () => {
  ...
  // SEO metadata
  const pageTitle = "Operations Decoded Podcast - Startup Leadership Insights";
  const pageDescription = "Listen to our podcast featuring conversations with founders, operators, and experts about the operational strategies behind successful startups.";
  const pageKeywords = "startup podcast, operations podcast, founder interviews, operational strategies, remote teams, HR revolution, startup leadership, legal frameworks";
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://masarna.co/resources/podcast" />
        <meta property="og:image" content="https://masarna.co/lovable-uploads/4c19cc81-9f30-4ff8-b639-79916ff68ecd.png" />
        <link rel="canonical" href="https://masarna.co/resources/podcast" />
      </Head>
                  ...
                  <div key={index} className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                      ...
                      <div className="flex items-center gap-4 mt-3 md:mt-0">
                        ...
                        <Button variant="outline" size="sm" className="flex items-center" aria-label={`Play ${episode.title}`}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                            <polygon points="5 3 19 12 5 21 5 3" />
                          </svg>
                        </Button>
