      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-masarna-teal/10 p-8 md:p-12 rounded-xl text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Need a tailored checklist?</h2>
            <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
              Our operational experts can create custom checklists specifically designed for your unique business challenges.
            </p>
            <Button 
