    ...
    <PageLayout title="Strategy Services" description="Strategic planning services for startups">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-6">Strategy & Planning Services</h1>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-masarna-teal">Our Strategy Services Include:</h2>
            <ul className="space-y-3 mb-6">
              <li className="flex items-start">
                ...
                <span className="text-gray-700">Vision and mission development</span>
              </li>
              <li className="flex items-start">
                <svg 
                  className="h-5 w-5 mr-2 mt-0.5 text-masarna-teal" 
                ...
                <span className="text-gray-700">Strategic goal setting and OKRs</span>
              </li>
              <li className="flex items-start">
                <svg 
                  className="h-5 w-5 mr-2 mt-0.5 text-masarna-teal" 
                ...
                <span className="text-gray-700">Product roadmap development</span>
              </li>
              <li className="flex items-start">
                <svg 
                  className="h-5 w-5 mr-2 mt-0.5 text-masarna-teal" 
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-700">Market positioning and differentiation</span>
              </li>
              <li className="flex items-start">
                <svg 
                  className="h-5 w-5 mr-2 mt-0.5 text-masarna-teal" 
                ...
                <span className="text-gray-700">Business model optimization</span>
              </li>
            </ul>
          </div>
          
          <div className="bg-masarna-teal/10 p-8 rounded-lg mt-12">
            <h3 className="text-xl font-semibold mb-4">Ready to develop your strategic roadmap?</h3>
